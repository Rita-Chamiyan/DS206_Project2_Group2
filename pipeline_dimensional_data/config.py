...
# This file is created locally by copying sql_server_config_template.cfg.
CONFIG_FILE_PATH = PROJECT_ROOT / "local_sql_server_config.cfg"
CONFIG_SECTION_NAME = "sql_server"


# Raw source Excel file used to load staging tables.
RAW_DATA_FILE_PATH = PROJECT_ROOT / "data" / "raw" / "raw_data_source.xlsx"
...
# Kept only for compatibility because the file exists in the project folder.
