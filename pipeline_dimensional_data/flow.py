...
from pipeline_dimensional_data.load_staging import load_excel_to_staging
...
class DimensionalDataFlow:
    ...
    The regular pipeline order is:
        1. Load Excel/source data into staging tables
        2. Update dimension tables
        3. Insert faulty fact rows into FactOrdersError
        4. Insert valid fact rows into FactOrders
    """
